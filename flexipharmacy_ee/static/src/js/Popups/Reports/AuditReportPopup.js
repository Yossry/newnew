odoo.define('flexipharmacy_ee.AuditReportPopup', function(require) {
    'use strict';
    ...
    class AuditReportPopup extends AbstractAwaitablePopup {
        ...
        mounted() {
            ...
            $('.report_pdf.session').click(function(e){
                ...
                self.env.pos.do_action('flexipharmacy_ee.report_pos_inventory_session_pdf_front',{additional_context:{
            ...
            $('.report_pdf.location').click(function(e){
                ...
                self.env.pos.do_action('flexipharmacy_ee.report_pos_inventory_location_pdf_front',{additional_context:{
