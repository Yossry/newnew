odoo.define('flexipharmacy_ee.CustomerDisplay', function (require) {
"use strict";
    ...
    const models = require('flexipharmacy_ee.models');
        ...
        _buildChrome() {
            if ($.browser.chrome) {
                ...
                if (parseInt(chrome_version, 10) >= 50) {
                    loadCSS('/flexipharmacy_ee/static/src/css/chrome51.css');
                }
            }
