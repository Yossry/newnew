...
class WizardSlowMovingInv(models.TransientModel):
    ...
    def print_report(self):
        if self.view_by == 'pdf':
            return self.env.ref('flexipharmacy_ee.pdf_slow_moving_inventory_report').report_action(self)
        else:
    ...
    def generate_xls_report(self):
        self.ensure_one()
        slow_move_inv_dict = self.env['report.flexipharmacy_ee.slow_moving_inv_report_pdf'].summary_data(
            self)
